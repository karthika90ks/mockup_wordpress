...
function abcfsl_mbox_groups_layout_cntr( $grpOptns ){
    ...
    echo abcfsl_autil_input_cls( 'grpCntrCustCls', $grpCntrCustCls, '', '', '', 73);
}
...
function abcfsl_mbox_groups_layout_item( $grpOptns ){
    ...
    echo abcfsl_autil_input_cls( 'grpNameCustCls', $grpNameCustCls, '', '', '', 73);
}
...
function abcfsl_mbox_groups_layout_item_hline( $grpOptns ){
    ...
    // $inputID, $inputValue, $F, $lblID, $helpID, $lblUrlID=''
    echo abcfsl_autil_input_cls( 'grpHLine', $grpHLine, '', '', '', 0);
}
