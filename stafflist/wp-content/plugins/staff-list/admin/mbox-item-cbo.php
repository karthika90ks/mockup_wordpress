...
function abcfsl_mbox_item_cbo_TEMP( $itemOptns, $tplateOptns, $isSingle) {
...
function abcfsl_mbox_item_cbo_CBOM( $tplateOptns, $itemOptns, $F, $showField ){
    ...
    $col2_13_S = abcfl_html_tag( 'div', '', 'abcflFGF2Col13' );
    $col2_23_S = abcfl_html_tag( 'div', '', 'abcflFGF2Col23' );
