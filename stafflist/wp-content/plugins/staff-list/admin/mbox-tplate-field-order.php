...
function abcfsl_mbox_tplate_field_order( $postID, $tplateOptns, $isSingle ){
...
//Labels displayed next to field names on sort screen. PRO=FREE
    ...
    if( $selectedFieldType != 'N '){
        ...
        switch ($selectedFieldType) {
            ...
            case 'CHECKG':
                ...
                break;               
            case 'IMGCAP':
                $fieldType = 'Image + Caption';
                break; 
            case 'IMGHLNK':
                $fieldType = 'Image Hyperlink + Caption';
                break; 
            case 'SLDTE':
                $fieldType = 'Static Lbl + Date';
                break; 
            case 'STARR':
