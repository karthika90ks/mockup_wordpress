...
function abcfsl_mbox_tplate_shortcode( $tplateID, $tplateOptns ) {
    ...
    echo  abcfl_html_tag('div','','inside  hidden');
        ...
        echo abcfl_input_txt_readonly('scode', '', $scode, abcfsl_txta(349),'', '100%', 'regular-text code abcflFontW700', '', 'abcflFldCntr abcflShortcode', 'abcflFldLbl');
        echo abcfl_input_txt_readonly('scodeSP', '', $scodeSP , abcfsl_txta(325), '', '100%', 'regular-text code abcflFontW700', '', 'abcflFldCntr abcflShortcode', 'abcflFldLbl');
        //----------------------------------
...
function abcfsl_mbox_tplate_shortcode_bday( $tplateID, $tplateOptns ) {

    if ( abcfsl_util_is_active_bday() ){     
        abcfslub_mbox_tplate_shortcode( $tplateID, $tplateOptns );
    } 
}
