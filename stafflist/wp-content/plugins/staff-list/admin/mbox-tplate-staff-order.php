...
function abcfsl_mbox_tplate_staff_order_sort_type( $sortType, $tplateID, $sortTxtInputType, $sortFieldF, $sortMPOrder ){
    ...
    switch ( $sortType ) {
        case 'M':
            ...
            break;
        case 'T':
            abcfsl_mbox_tplate_staff_order_T( $sortTxtInputType, $sortType, $sortFieldF, $sortMPOrder );
            break;
        case 'P':
...
function abcfsl_mbox_tplate_staff_order_T( $sortTxtInputType, $sortType, $sortFieldF, $sortMPOrder ){
