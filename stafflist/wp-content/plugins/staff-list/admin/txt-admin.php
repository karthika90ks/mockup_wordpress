...
//--------------------------------
        case 190:
            ...
            break;
        case 191:
            $out = __('Copy from Multipart Field', 'staff-list');
            break;
        case 192:
            $out = 'Isotope';
            break;
...
//--------------------------------
        ...
        case 261:
            ...
            break;
        case 262:
            $out = __('To create a link to built-in Single Page enter <span class="abcflFontW700">SP</span>. For other links enter URL.', 'staff-list');
            break;
        case 263:
...
//--------------------------------
        ...
        case 294:
            ...
            break;
        case 295:
            $out = __('Select: <b>Yes</b> to horizontally center content container when width < 100%.', 'staff-list');
            break;
        case 296:
...
//--------------------------------
        ...
        case 332:
            ...
            break;
        case 333:
            $out = __('You have to update the shortcode after template conversion.', 'staff-list');
            break;            
        case 334:
        ...
        case 335:
            ...
            break;
        case 336:        
            $out = __('Field Order - Staff Page/Single Page', 'staff-list');
            break;
        case 337:
...
//--------------------------------
        ...
        case 377:
            ...
            break;
        case 378:
            $out = __('Link staff image to Single Page (image hyperlink).', 'staff-list');
            break;
        case 379:
...
//--------------------------------            
        case 380:
            ...
            break; 
        case 381:
            $out = __('Static Label + Phone', 'staff-list');
            break;
        case 382:
...
//--------------------------------         
        ...
        case 393:
            ...
            break; 
        case 394:
            $out = __('Date Saved Format', 'staff-list');
            break;
        case 395:
