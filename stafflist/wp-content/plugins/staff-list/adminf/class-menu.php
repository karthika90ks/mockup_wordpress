...
if (!class_exists("ABCFSL_Admin_Menu")) {
    ...
    class ABCFSL_Admin_Menu {
        ...
        function add_menu() {
            ...
            //add_menu_page('Staff List', 'Staff List', $capEditor, $slug, '', 'dashicons-groups', 81);
...
//#########################################################################
    ...
    //     //add_submenu_page( $parent_slug, $page_title, $menu_title, $capability, $menu_slug, $function );
    //     add_submenu_page( $slug, abcfsl_txta(57), abcfsl_txta(57), $capSCE, 'edit-tags.php?taxonomy=tax_staff_member_cat&post_type=cpt_staff_lst_item' );
    //     add_submenu_page( $slug, abcfsl_txta(12), abcfsl_txta(12), $capEditor, 'abcfsl-admin-tabs', array (&$this, 'load_page'));
    // }
