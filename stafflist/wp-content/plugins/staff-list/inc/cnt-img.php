...
function abcfsl_cnt_img_cntr( $tplateOptns, $itemOptns, $par ){
    ...
    switch ( $pgLayout ) {
        case 1:
            $imgCntr = abcfsl_cnt_img_list_img_cntr( $colL, $imgCntrCustCls, '', $pfix, $vAidCls );
            break;
        case 2:
            $imgCntr = abcfsl_cnt_img_grid_b_img_cntr( $colL, $imgCntrCustCls, '', $pfix, $vAidCls );
            break;
        case 3:
...
function abcfsl_cnt_img_tag( $tplateOptns, $itemOptns, $isSingle, $pgLayout, $pfix ){
    ...
    return abcfl_html_img_tag_resp( '', $imgUrl, $alt, '', $imgClasses, $imgStyle);
}

function abcfsl_cnt_img_options( $tplateOptns, $itemOptns, $par ){

    $pgLayout = $par['pgLayout'];
    $itemID = $par['itemID']; //postID
    $pfix = $par['clsPfix'];
    ...
    $lnkParts = abcfsl_spg_a_tag_img_lnk_parts( $itemID, $sPageUrl, $itemOptns, $imgLnkL );
...
//function abcfsl_cnt_img_imgATag( $imgHover, $hrefUrl, $imgTag, $target, $pfix )
function abcfsl_cnt_img_imgATag( $imgHover, $imgTag, $lnkParts, $pfix ){

    $out['imgHover'] = abcfsl_util_cls_bldr( $imgHover, $pfix );

    //OLD
    //$out['imgATag'] = abcfl_html_a_tag_nb( $lnkParts['href'], $imgTag, $lnkParts['target'], '', '', '', $lnkParts['onclick'], $lnkParts['args'] );
...
function abcfsl_cnt_img_list_img_cntr( $colL, $customCls, $customStyle, $pfix, $vAidCls ){

    $colCls = $pfix . 'LstCol ' . $pfix . 'LstCol-' . $colL . ' ' . $pfix . 'ImgColLst' . $vAidCls;
...
function abcfsl_cnt_img_grid_a_img_cntr( $pfix, $baseCls, $customCls, $customStyle, $vAidCls, $divID, $itemID, $addItemCls, $isSingle ){
...
function abcfsl_cnt_img_grid_b_img_cntr( $colL, $customCls, $customStyle, $pfix, $vAidCls ){


    $colCls = $pfix . 'LstCol ' . $pfix . 'LstCol-' . $colL . ' ' . $pfix . 'ImgColGridB' . $vAidCls;
...
function abcfsl_cnt_img_igrid_a_img_cntr( $pfix, $baseCls, $customCls, $customStyle, $vAidCls, $divID, $itemID, $addItemCls, $isSingle ){
