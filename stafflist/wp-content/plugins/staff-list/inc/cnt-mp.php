...
//== MP FIELD START ==========================================
function abcfsl_cnt_MP( $par, $tplateOptns, $itemOptns, $F ){

    $spanMP = abcfsl_cnt_MP_field( $tplateOptns, $itemOptns, $F, $par['isSingle'] );
...
function abcfsl_cnt_MP_field( $tplateOptns, $itemOptns, $F, $isSingle, $addSpan=true ){
    ...
    if( abcfl_html_isblank( $mp1 . $mp2 . $mp3 . $mp4 ) ) { return ''; }
