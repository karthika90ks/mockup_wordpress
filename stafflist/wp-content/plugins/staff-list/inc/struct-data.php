...
//Returns array
function abcfsl_struct_data_item_grid( $tplateOptns, $itemOptns, $staffID ){
    return abcfsl_struct_data_item_array ( $tplateOptns, $itemOptns, false, $staffID );
}
...
function abcfsl_struct_data_item_array ( $tplateOptns, $itemOptns, $isSingle, $staffID ){
...
function abcfsl_struct_data_field_value_SPTL( $staffID, $tplateOptns, $itemOptns, $out ){
    ...
    //--------------------------------------------
    $urlSelector = abcfsl_spg_a_tag_url_selector( $staffID, 'SP', $sPageUrl, $pretty );
...
function abcfsl_struct_data_field_value_MP( $tplateOptns, $itemOptns, $F, $isSingle, $out ){
    ...
    $lineTxt = abcfsl_cnt_MP_field( $tplateOptns, $itemOptns, $F, $isSingle, false );
...
function abcfsl_struct_data_sp( $url,  $tplateOptns, $itemOptns ){
    ...
    $pretty = isset( $itemOptns['_pretty'] ) ? esc_attr( $itemOptns['_pretty'][0] ) : '';
    //--------------------------------------------
    $urlSelector = abcfsl_spg_a_tag_url_selector( '', 'SP', $sPageUrl, $pretty );
