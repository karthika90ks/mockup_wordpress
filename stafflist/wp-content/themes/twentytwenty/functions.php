...
function shapeSpace_include_custom_jquery() {
	...
	wp_enqueue_script('jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js', array(), null, true);

}
add_action('wp_enqueue_scripts', 'shapeSpace_include_custom_jquery');

function my_frontend_script() {
    wp_enqueue_script( 'my_script', get_template_directory_uri() . '/my_script.js', array( 'jquery' ), '1.0.0', true );
}
